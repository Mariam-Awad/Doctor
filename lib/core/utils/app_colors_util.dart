...
class AppColorUtil {
  ...
  static Color iconsDarkGreen = const Color(0xff028E8E);
  static Color textDarkGreen = const Color(0xff028E8E);

  // Grey
  static Color shadowGrey = const Color(0xffDDDDDD);
  static Color backgroundGrey = const Color(0xffF2F2F2);
  static Color textgrey = const Color(0xffE5E5E5);
  static Color textLightGrey = const Color(0xffCCCACA);
  static Color textSemiDarkGrey = const Color(0xffA5A5A5);
  static Color textDarkGrey = const Color(0xff77838F);
